...
const Hero = () => {
  ...
  return (
    <section id='hero' className='w-full lg:px-20 px-10 py-10 h-[600px] bg-cover bg-center flex flex-col justify-center items-start gap-8' style={{ backgroundImage: `url(${banner4.src})` }}>
      ...
      <p data-aos="zoom-in" className='text-xl text-white font-lg'>Lorem ipsum, dolor sit amet consectetur adipisicing elit.<br /> Accusamus sed ipsam labore. Aspernatur nam id, <br />debitis error velit itaque rem.</p>
